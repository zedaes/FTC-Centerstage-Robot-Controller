...
public class BlueDepositOffenseDetectOnePixelRightParkThroughLeft extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        placePixelOnBackstage(leftSlide, rightSlide, leftOutakeFlip, rightOutakeFlip);
        sleep(0);
        parkRight(robot, currentPose);
    ...
    public void goToBackstageLeft(MecanumDrive robot, Pose2d pose){
        Actions.runBlocking(
                robot.actionBuilder(pose)
                        .strafeToLinearHeading(startVector, Math.toRadians(0))
    ...
    public void goToBackstageRight(MecanumDrive robot, Pose2d pose){
        Actions.runBlocking(
                robot.actionBuilder(pose)
                        ...
                        .strafeToLinearHeading(new Vector2d(-40, 60), Math.toRadians(180))
                        .strafeTo(new Vector2d(36,60))
                        .strafeTo(new Vector2d(47.5, 32))
                        .build());
    }

    public void placePixelOnBackstage(DcMotor leftMotor, DcMotor rightMotor, Servo leftServo, Servo rightServo){
        ...
        flipOutakeUp(leftServo, rightServo);
        releasePixel();
        flipOutakeDown(leftServo, rightServo);


    }

    public void parkRight(MecanumDrive robot, Pose2d pose){
        Actions.runBlocking(
                robot.actionBuilder(pose)
    ...
    public void placePixelOnLine(){

    }

    public void flipOutakeUp(Servo leftServo, Servo rightServo){
        leftServo.setPosition(flipUpPosition);
        rightServo.setPosition(flipUpPosition);
    }

    public void flipOutakeDown(Servo leftServo, Servo rightServo){
