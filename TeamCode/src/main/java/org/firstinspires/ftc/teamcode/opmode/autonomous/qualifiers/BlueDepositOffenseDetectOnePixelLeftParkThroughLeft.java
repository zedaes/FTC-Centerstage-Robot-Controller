...
public class BlueDepositOffenseDetectOnePixelLeftParkThroughLeft extends LinearOpMode {
    ...
    public void parkLeft(MecanumDrive robot, Pose2d pose){
        Actions.runBlocking(
                robot.actionBuilder(pose)
